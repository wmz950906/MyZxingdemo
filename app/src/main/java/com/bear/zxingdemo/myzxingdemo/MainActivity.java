package com.bear.zxingdemo.myzxingdemo;

import java.util.Hashtable;

import com.bear.zxingdemo.zxing.activity.CaptureActivity;
import com.bear.zxingdemo.zxing.encoding.EncodingHandler;
...
//				Bitmap qrcodeBitmap = EncodingHandler.createQRCode(content, 400);
				Bitmap qrcodeBitmap = EncodingHandler.createQRCodeWithLogo(content, 400, BitmapFactory.decodeResource(getResources(),R.drawable.fengculogo));
